        ...
        <div className="flex flex-col md:flex-row h-[calc(100vh-80px)] overflow-hidden">
            ...
            <div className="w-full md:w-[70%] h-[50vh] md:h-full relative bg-gray-100 border-r border-gray-200">
                ...
                {!mapLoaded && (
                    <div className="absolute inset-0 flex items-center justify-center bg-gray-100 z-10">
                        <Typography color="gray">지도를 불러오는 중...</Typography>
                    </div>
                )}
                ...
                {selectedPerformance && (
                    <div className="md:hidden absolute bottom-0 left-0 right-0 bg-white p-4 border-t border-gray-200 z-20 shadow-lg">
                        <div className="flex justify-between items-start mb-2">
                            <Typography variant="h6" className="font-bold truncate pr-4">{selectedPerformance.title}</Typography>
                            <button onClick={() => setSelectedPerformance(null)} className="text-gray-500">✕</button>
                        </div>
                        <Typography variant="small" className="text-gray-600 mb-1">{selectedPerformance.place}</Typography>
                        <Typography variant="small" className="text-gray-500 mb-3">{selectedPerformance.period}</Typography>
                        <Button 
                            size="sm" 
                            fullWidth 
            ...
            <div className="w-full md:w-[30%] h-[50vh] md:h-full bg-white overflow-y-auto p-0 border-l border-gray-200">
                <div className="p-6 border-b border-gray-100 sticky top-0 bg-white z-10">
                    <Typography variant="h5" className="font-bold mb-1 tracking-tight">공연장 지도</Typography>
                    <Typography variant="small" color="gray">지도에서 마커를 클릭하여 공연 정보를 확인하세요.</Typography>
                </div>
                        ...
                        {selectedPerformance ? (
                            <div className="p-6 bg-gray-50">
                                <div className="flex justify-between items-center mb-4">
                                    <Typography variant="h6" className="font-bold">선택된 공연</Typography>
                                    <Button 
                                        variant="text" 
                                        size="sm" 
                                ...
                                <Card className="rounded-none shadow-sm border border-gray-200 p-0 overflow-hidden">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <Typography variant="h6" className="font-bold mb-2 leading-tight">
                            ...
                            performances.map((perf) => (
                                ...
                                >
                                    <Typography variant="small" className="font-bold mb-1 group-hover:text-blue-600 transition-colors">
                                        {perf.title}
                                    </Typography>
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <Typography className="text-xs text-gray-600">{perf.place}</Typography>
                                            <Typography className="text-[10px] text-gray-400">{perf.period}</Typography>
                                        </div>
